...
export default async function CampaignLayout({ children, params }: { children: React.ReactNode, params: { id: string } }) {
  ...
  const navItems: NavItem[] = [
    ...
    { id: 'tasks', label: 'Tasks', href: `/plugins/biz-ops/campaigns/${params.id}?tab=tasks`, icon: 'CheckSquare', roles: ['admin', 'member'] },
    { id: 'files', label: 'Files', href: `/plugins/biz-ops/campaigns/${params.id}?tab=files`, icon: 'Folder', roles: ['admin', 'member'] },
    { id: 'finances', label: 'Finances', href: `/plugins/biz-ops/campaigns/${params.id}?tab=finances`, icon: 'CreditCard', roles: ['admin', 'member'] },
    { id: 'settings', label: 'Settings', href: `/plugins/biz-ops/campaigns/${params.id}?tab=settings`, icon: 'Settings', roles: ['admin', 'member'] },
  ];
