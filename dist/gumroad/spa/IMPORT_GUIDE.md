# Import Guide — Spa & Wellness Template for izhubs ERP
...
- **7 pipeline stages**: Hỏi dịch vụ → Đã đặt lịch → Xác nhận → Khách đến → Đang phục vụ → Hoàn thành → Huỷ
- **8 custom fields** tailored for Spa & Wellness
- **2 automations** pre-configured
- Dashboard layout with relevant widgets
- Sidebar navigation for your team roles

## Support
- Docs: https://docs.izhubs.com/templates/spa
