# Import Guide — Coworking / Văn phòng cho thuê Template for izhubs ERP
...
- **8 pipeline stages**: Mới → Đã liên hệ → Đang tư vấn → Xem văn phòng → Chốt hẹn ký → Khách hàng → Không phù hợp → Chuyển đối tác
- **9 custom fields** tailored for Coworking / Văn phòng cho thuê
- **2 automations** pre-configured
- Dashboard layout with relevant widgets
- Sidebar navigation for your team roles

## Support
- Docs: https://docs.izhubs.com/templates/coworking
