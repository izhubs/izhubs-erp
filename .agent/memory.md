...
| **Widgets Location** | Dashboard and highly reusable UI fragments MUST go to `components/widgets/`. |
| **External Plugins** | Third-party plugins MUST use API Webhooks/gRPC, NOT the internal Event Bus. |
